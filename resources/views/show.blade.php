    ...
    <div class="row justify-content-center">
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <form class="d-inline" method="post" action="{{ route('like', $item->id) }}">
            @csrf
            @method('put')
          ...
          <form class="d-inline" method="post" action="{{ route('dislike', $item->id) }}">
            @csrf
            @method('put')
          ...
          <div class="card-body">
            <form method="post" action="{{ route('comments.store') }}">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" name="text" id="text" rows="3"
                  required></textarea>
